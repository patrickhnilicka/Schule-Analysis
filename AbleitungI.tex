...
% \end{enumerate}
Der Differenzialquotient hat neben der durchschnittlichen Änderungsrate auch eine geometrische Bedeutung: Er entspricht der Steigung der Sekante durch die Punkte $(a, f(a))$ und $(b, f(b))$ auf dem Graphen der Funktion $f$.
\subsection{Übungen}
\begin{enumerate}
    ...
    \item Skizzieren Sie den Graphen der Funktion \( f(x) = x^2 - 5 \).
          \begin{enumerate}
              ...
              \item Bestimmen Sie \( f'(-2) \). Entweder mit dem Differenzialquotient oder indem Sie eine Eigenschaft der Parabel verwenden\dots
          \end{enumerate}
