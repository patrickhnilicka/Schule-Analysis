...
\begin{enumerate}
    ...
    \item Gegeben sind die beiden Funktionen $f$ und $g$ mit den Funktionstermen $f(x)=x^2+1$ und $g(x)=(x+1)^2$. Bestimmen Sie die Ableitung der gegebenen Funktion.
    \begin{multicols}{4}
        \begin{enumerate}
            \item $p(x)=f(g(x))$
            \item $q(x)=g(f(x))$
...
\begin{enumerate}
    \item Bestimmen Sie die Ableitung der folgenden Funktionen:
          \begin{enumerate}
              ...
              \item $y'=\dfrac{1}{4\sqrt{x}\cdot \sqrt{1+\sqrt{x}}}$
              \item $y'=4x(3x-2)(1-x^2+x^3)^3$
          \end{enumerate}
