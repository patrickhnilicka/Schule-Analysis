...
\begin{enumerate}
    \item Bestimmen Sie die Ableitung der folgenden Funktionen.
          \begin{enumerate}
              ...
              \item $y=\frac{h(x)}{g(x)}$
          \end{enumerate}
    \item Zwei Funktionen lassen sich nicht ohne weiteres Ableiten. Welche?

    \item Gilt für das Produkt zweier Funktionen die Regel $[g\cdot h]'=g'\cdot h'$? Überprüfen Sie diese Vermutung anhand von Aufgabe 5.
\end{enumerate}
\clearpage
